from luizalabs_project.api.customer_api import CustomerAPI, CustomersListAPI, CustomerListAPI
...
def add_resources(api_flask):
    ...
    api_flask.add_resource(CustomerListAPI, '/api/customer/<string:customer_id>',
                            endpoint='list_one')
    api_flask.add_resource(CustomersListAPI, '/api/customer/all')

    # Customer's favorite Endpoint
    api_flask.add_resource(FavoritesListAPI, '/api/favorites/<string:customer_id>')
